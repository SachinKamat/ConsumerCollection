...
function inflightJSON( xmlFile )
{
   printf nl"{%s",nl >> xmlFile #add opening bracket
		signature = "{\n\t\t\"svg\":{\n\t\t\t\"polyline\":{\n\t\t\t \"style\":\"fill:none\;stroke:\#000000\;stroke-width:4.0\"\,\n\t\t\t\"points\":\"645.06244,147.52148 645.06244,147.52148\"\n\t\t}\,\n\t\t\t\"height\":530\,\n\t\t\t\"width\":660\n\t\t}\n\t}"
        doCSVElement("Barcode","", "", xmlFile)
		...
		doCSVElement("ObiId", "","", xmlFile)
		doCSVElement("Latitude", "INT","", xmlFile)
		doCSVElement("Longitude", "INT","", xmlFile)
		doCSVElement("Altitude", "INT","", xmlFile)
		doCSVElement("EventCode", "","", xmlFile)
		doCSVElement("ScanTime", "","", xmlFile)
		doCSVElement("RecieveTime", "","", xmlFile)
		doCSVElement("SubmissionTime", "","", xmlFile)
		doCSVElement("ManualEntry", "BOOL","", xmlFile)
		doCSVElement("UniqueItemNumber", "","", xmlFile)
		doCSVElement("UpuTrackingNumber", "","", xmlFile)
		doCSVElement("FunctionalLocationId", "INT","", xmlFile)
		doCSVElement("EventReason", "","", xmlFile)
		doCSVElement("WorkProcessCode", "INT","", xmlFile)
		doCSVElement("SafePlacePositionCode", "","", xmlFile)
		doCSVElement("SafePlaceLatitude", "INT","", xmlFile)
		doCSVElement("SafePlaceLongitude", "INT","", xmlFile)
		doCSVElement("SafePlaceAltitude", "INT","", xmlFile)
		doCSVElement("NeighbourName", "","", xmlFile)
		doCSVElement("NeighbourBuildingName","", "", xmlFile)
		doCSVElement("NeighbourAddressLine1", "","", xmlFile)
		doCSVElement("ImageURI", "","", xmlFile)
		doCSVElement("TaskId", "","", xmlFile)
		doCSVElement("SignatureName","", "", xmlFile)
		doCSVElement("ScanComment", "","", xmlFile)
		doCSVElement("SignatureSVG", "",signature, xmlFile)
